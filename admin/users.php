...
if(isset($_GET['add'])){
    ...
    if($_POST){
      ...
      if(!empty($errors)){
        ...
        $_SESSION['success_flash'] = 'User has been created!';
        header('Location: users.php');
      }
    }
    ?>
    <h3 class="text-center">Add a New User</h2><hr>
    <div class="container">
...
<a href="users.php?add=1" class="btn btn-danger pull-right" id="add-product-btn">Add User</a><div class="clearfix"></div><hr>
